...
const signUp = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const [emailFound] = yield server_1.db.execute(`SELECT email FROM userDetails where email = ?`, [email]);
...
const verifyOtp = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (otpBody === otpSaved) {
            ...
            const [rows] = yield server_1.db.execute(`INSERT INTO userDetails (name, email, password) VALUES (?, ?, ?)`, [userDetails.name, userDetails.email, userDetails.password]);
...
const signIn = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const [userFound] = yield server_1.db.execute(`SELECT * FROM userDetails WHERE email = ?`, [email]);
...
const addNote = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const [userData] = yield server_1.db.execute(`SELECT id FROM userDetails WHERE email = ?`, [userId]);
        ...
        const [insertedNote] = yield server_1.db.execute(`INSERT INTO notes (userId, title, content,createdAt) VALUES (?, ?, ?,?)`, [user_id, title, content, createdDate]);
...
const getNotes = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const count = yield server_1.db.execute(countQuery);
        ...
        const [allNotes] = yield server_1.db.execute(
...
const getSingleNote = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const [singleNotes] = yield server_1.db.execute(`SELECT * FROM notes WHERE userId=? AND id=?`, [user_id, noteId]);
...
const editNote = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const [editNote] = yield server_1.db.execute(`UPDATE notes SET title=?, content=? WHERE id=?`, [title, content, id]);
...
const trashNote = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const [trashnote] = yield server_1.db.execute(`UPDATE notes SET isDeleted=1 WHERE userId=? AND id=?`, [user_id, notesid]);
...
const restoreNote = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user_id = userRecord.id;
        let notesid = req.query.id;
        const [restorenote] = yield server_1.db.execute(`UPDATE notes SET isDeleted=0 WHERE userId =? AND id=?`, [user_id, notesid]);
...
const deleteNote = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const [result] = yield server_1.db.execute("DELETE FROM notes WHERE id = ?", [id]);
